...
public class EVManuaConfig {
    ...
    public static String getManuaDownLoadUrl(Context context) {
        ...
        return EVManuaConfig.BASE_URL + HS5SharedpreferencesUtil.getCarModel(context) + ".zip";
    }

    public static String getManuaUpDataUrl(Context context) {

        return EVManuaConfig.BASE_URL + HS5SharedpreferencesUtil.getCarModel(context) + "A.zip";
    }
}
